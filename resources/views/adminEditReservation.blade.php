...
<body>
    ...
    <form action="{{ route('admin.update.reservation', $reservation->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <select name="movie_id" id="movie_id" class="form-control">
                <option value="" disabled>映画を選択</option>
        ...
        <div class="form-group">
            ...
            <select name="schedule_id" id="schedule_id" class="form-control">
                <option value="" disabled>スケジュールを選択</option>
                @foreach ($schedules as $schedule)
                    <option value="{{ $schedule->id }}"
                        {{ $reservation->schedule_id == $schedule->id ? 'selected' : '' }}>
        ...
        <div class="form-group">
            ...
            <select name="sheet_id" id="sheet_id" class="form-control">
                <option value="" disabled>席を選択</option>
                @foreach ($sheets as $sheet)
                    <option value="{{ $sheet->id }}" {{ $reservation->sheet_id == $sheet->id ? 'selected' : '' }}>
